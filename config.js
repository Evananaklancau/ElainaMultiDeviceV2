...
/*============== SOCIAL ==============*/
global.sig = 'https://instagram.com/arilcuy77' //instagram
...
/*============== CPANEL ==============*/
global.domain = 'https://bandithost.kedai-panel.my.id' //domain
global.capikey = 'ptlc_zQFNFdXG7MZyoC8zdXCYsEKXhFCpfjWrZHz03vvdOxY' //pltc
global.apikey = 'ptla_6Vvy6VvRxJuzWMT8rhyE8X7xJ1TN4sIsTLwqGkpFD3c' //plta
...
/*============== WATERMARK ==============*/
global.wm = 'ᴀʀɪʟ ᴀʀᴅɪᴀɴsʏᴀʜ ' //wm1
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘ᴇʟᴀɪɴᴀ - ᴀɪ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷' //wm2
global.wm3 = '• ᴇʟᴀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ' //wm3
global.namedoc = 'ᴀʀɪʟ ᴀʀᴅɪᴀɴsʏᴀʜ ' //nama document
global.botdate = `• ᴅᴀʏ's: ${week} ${date}`
global.bottime = `ᴛɪᴍᴇ: ${wktuwib}`
global.titlebot = 'ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ ᴀʀɪʟ ᴍᴅ ッ'
global.author = global.wm
global.md = 'Tunggu Sebentar Ya Kack ^ω^'
global.stiker_wait = '🚩 ʟᴏᴀᴅɪɴɢ ᴘʟᴇᴀsᴇ ᴡᴀɪᴛ...'
